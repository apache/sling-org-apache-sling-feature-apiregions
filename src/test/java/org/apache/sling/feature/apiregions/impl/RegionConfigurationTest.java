...
public class RegionConfigurationTest {
    ...
    public void testLoadBSNVerMap() throws Exception {
        ...
        assertEquals(
                Collections.singletonList("g:b1:1"),
                re.bsnVerMap.get(new AbstractMap.SimpleEntry<String, Version>("b1", new Version(1, 0, 0))));
        assertEquals(
                new HashSet<>(Arrays.asList("g:b2:1.2.3", "g2:b2:1.2.4")),
                new HashSet<>(
                        re.bsnVerMap.get(new AbstractMap.SimpleEntry<String, Version>("b2", new Version(1, 2, 3)))));
    ...
    public void testLoadBSNVerMapAndConfig() throws Exception {
        ...
        assertEquals(
                ...
                new HashSet<>(
                        re.bsnVerMap.get(new AbstractMap.SimpleEntry<String, Version>("b2", new Version(1, 2, 3)))));
        assertEquals(
                Collections.singletonList("g3:b3:2.7"),
    ...
    public void testLoadBundleFeatureMap() throws Exception {
        ...
        assertEquals(
                Collections.singleton("org.sling:something:1.2.3:slingosgifeature:myclassifier"),
        ...
        assertEquals(
                new HashSet<>(Arrays.asList(
                        "some.other:feature:123", "org.sling:something:1.2.3:slingosgifeature:myclassifier")),
    ...
    public void testLoadBundleFeatureMapAndConfig() throws Exception {
        ...
        assertEquals(Collections.singleton("fg1:fa1:3.0"), re.bundleFeatureMap.get("g3:b3:2.7"));
        assertEquals(
                Collections.singleton("org.sling:something:1.2.3:slingosgifeature:myclassifier"),
                re.bundleFeatureMap.get("org.sling:b1:1"));
        assertEquals(
        ...
        assertEquals(4, re.bundleFeatureMap.size());
        assertEquals(Collections.emptySet(), re.bundleFeatureMap.get("g3:b3:2.7"));
        assertEquals(
                Collections.singleton("org.sling:something:1.2.3:slingosgifeature:myclassifier"),
                re.bundleFeatureMap.get("org.sling:b1:1"));
        assertEquals(
    ...
    public void testLoadFeatureRegionMap() throws Exception {
        ...
        assertEquals(Collections.singletonList("global"), re.featureRegionMap.get("an.other:feature:123"));
        assertEquals(Arrays.asList("global", "internal"), re.featureRegionMap.get("org.sling:something:1.2.3"));
    ...
    public void testLoadFeatureRegionMapAndConfig() throws Exception {
        ...
        assertEquals(Collections.singletonList("newregion"), re.featureRegionMap.get("fg1:fa1:3.0"));
        assertEquals(Collections.singletonList("global"), re.featureRegionMap.get("an.other:feature:123"));
        assertEquals(Arrays.asList("global", "internal"), re.featureRegionMap.get("org.sling:something:1.2.3"));
    ...
    public void testLoadRegionPackageMap() throws Exception {
        ...
        assertEquals(Collections.singleton("xyz"), re.regionPackageMap.get("internal"));
        assertEquals(new HashSet<>(Arrays.asList("a.b.c", "d.e.f", "test")), re.regionPackageMap.get("global"));
    ...
    public void testLoadRegionPackageMapAndConfig() throws Exception {
        ...
        assertEquals(2, re.regionPackageMap.size());
        assertEquals(new HashSet<>(Arrays.asList("xyz", "r.i.p")), re.regionPackageMap.get("internal"));
        assertEquals(new HashSet<>(Arrays.asList("a.b.c", "d.e.f", "test")), re.regionPackageMap.get("global"));
    ...
    public void testJoinRegionsToGlobal() throws Exception {
        ...
        assertEquals(new HashSet<>(Arrays.asList("xyz", "a.b.c", "d.e.f", "test")), re.regionPackageMap.get("global"));
    }
    ...
    public void testURLs() throws Exception {
        ...
        String location = new File(
                        getClass().getResource("/props1/idbsnver.properties").getFile())
                .getParentFile()
                .toURI()
                .toString();
    ...
    public void testOrderingOfRegionsInFeatures() throws Exception {
        BundleContext ctx = Mockito.mock(BundleContext.class);
        Mockito.when(ctx.getBundle()).thenReturn(Mockito.mock(Bundle.class));
        Mockito.when(ctx.getProperty(PROPERTIES_FILE_LOCATION)).thenReturn("classloader://props2");
    ...
    public void testUpdateLocationCacheOnConfigUpdate() throws Exception {
        ...
        BundleContext ctx = Mockito.mock(BundleContext.class);
        Mockito.when(ctx.getBundle()).thenReturn(Mockito.mock(Bundle.class));
        Mockito.when(ctx.getProperty(PROPERTIES_FILE_LOCATION)).thenReturn("classloader://props4");
        RegionConfiguration cfg = new RegionConfiguration(ctx);
        ...
        assertEquals(
                Collections.singletonList("g:b2:1.2.3"),
        ...
        assertEquals(
                "caps should be empty it b4 doesn't have regions configuration yet", Collections.emptyList(), caps1);
        ...
        assertEquals(
                new AbstractMap.SimpleEntry<>("b1", new Version(1, 0, 0)),
                cfg.getBundleLocationConfigMap().get("http://b1"));
        assertEquals(
                new AbstractMap.SimpleEntry<>("b2", new Version(1, 2, 3)),
                cfg.getBundleLocationConfigMap().get("http://b2"));
        assertEquals(
                new AbstractMap.SimpleEntry<>("b4", new Version(9, 9, 9, "something")),
        ...
        d.put("mapping.bundleid.bsnver", new String[] {"g:b3:1.2=a.b3.c~1.2", "g:b4:9.9.9.something=b4~9.9.9.something"
        });
        d.put("mapping.bundleid.features", new String[] {"g:b4:9.9.9.something=org.sling:something:1.2.3"});
        ...
        assertEquals(
                ...
                cfg.getBsnVerMap().get(new AbstractMap.SimpleEntry<>("b2", new Version(1, 2, 3))));
        assertEquals(
                Collections.singletonList("g:b3:1.2"),
                cfg.getBsnVerMap().get(new AbstractMap.SimpleEntry<>("a.b3.c", new Version(1, 2, 0))));
        assertEquals(
                Collections.singletonList("g:b4:9.9.9.something"),
        ...
        assertEquals(
                "Now b4 from the req should have visibility to both caps as b4 is now in the feature", expected, caps2);
    }
    ...
    private void assertBSNVerMapUnmodifiable(Map<Map.Entry<String, Version>, List<String>> m) {
        Map.Entry<Map.Entry<String, Version>, List<String>> entry =
        ...
        try {
            m.put(new AbstractMap.SimpleEntry<>("hi", Version.parseVersion("1.2.3")), Collections.singletonList("xyz"));
    ...
    private void assertMapUnmodifiable(Map<String, ? extends Collection<String>> m) {
        Map.Entry<String, ? extends Collection<String>> entry =
                m.entrySet().iterator().next();
        try {
